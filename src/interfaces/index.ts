...
export interface PlaybackContextTrack extends Entity {
  artists: Entity[];
  content_type: string;
...
export interface PlaybackContextRestrictions {
  pause: string[];
  resume: string[];
  seek: string[];
  skip_next: string[];
...
export interface PlaybackContextMetadata extends Entity {
...
export type PlaybackInstanceListener = (inst: WebPlaybackInstance) => void;
export type PlaybackStateListener = (s: PlaybackState) => void;
